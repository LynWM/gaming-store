...
export const api = {
  ...
  getWishlist: (userId) => request(`/api/wishlist/${userId}`),
  addToWishlist: (userId, data) => request(`/api/wishlist/${userId}`, { method: 'POST', body: JSON.stringify(data) }),
  removeFromWishlist: (userId, wishlistId) => request(`/api/wishlist/${userId}/${wishlistId}`, { method: 'DELETE' }),
