...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#110D1A] border-b border-[#231C30] relative">
      <div className="h-16 flex items-center px-4 sm:px-6 justify-between gap-2 sm:gap-4">
        {/* logo */}
        <Link to="/" className="text-lg sm:text-xl font-black tracking-wider uppercase shrink-0 cursor-pointer">
          <span className="text-white">NEX</span>
          <span className="text-purple-500">PLAY</span>
        </Link>

        {/* Search: inline from md breakpoint up */}
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-4 sm:py-2 bg-[#1B1625] text-sm text-gray-200 rounded-full border border-[#2A233A] hover:bg-[#231C30] focus:outline-none focus:ring-1 focus:ring-purple-500"
          >
          ...
          <Link
            to="/"
            className="hidden sm:flex items-center gap-2 px-4 py-2 bg-[#1B1625] text-sm text-gray-200 rounded-full border border-[#2A233A] hover:bg-[#231C30] focus:outline-none focus:ring-1 focus:ring-purple-500"
          >
            <Gamepad2 size={16} />
          </Link>
          ...
          <Link
            to="/wishlist"
            className="flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-4 sm:py-2 bg-[#1B1625] text-sm text-gray-200 rounded-full border border-[#2A233A] hover:bg-[#231C30] focus:outline-none focus:ring-1 focus:ring-purple-500"
          >
            <Heart size={16} />
          </Link>
          ...
          <Link
            to="/cart"
            className="flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-4 sm:py-2 bg-[#1B1625] text-sm text-gray-200 rounded-full border border-[#2A233A] hover:bg-[#231C30] focus:outline-none focus:ring-1 focus:ring-purple-500 relative"
          >
          ...
          {user ? (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex items-center gap-1.5 sm:gap-2 justify-center w-10 h-10 sm:w-auto sm:h-auto px-0 sm:px-4 py-0 sm:py-2 bg-[#1B1625] text-sm text-gray-200 rounded-full border border-[#2A233A] hover:bg-[#231C30]"
              >
                <User size={16} />
                <span className="hidden lg:inline">{user.first_name}</span>
                <ChevronDown size={14} className={`hidden sm:inline transition-transform ${menuOpen ? "rotate-180" : ""}`} />
              </button>
      ...
      {/* Search: full-width dropdown on mobile/tablet, toggled */}
      {mobileSearchOpen && (
        <form
          onSubmit={handleSearch}
          className="md:hidden px-4 pb-3 sm:px-6 border-t border-[#231C30] pt-3"
        >
